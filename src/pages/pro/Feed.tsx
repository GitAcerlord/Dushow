  ...
  return (
    <div className="p-8 max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1 space-y-4">
              <Textarea 
                ...
                className="min-h-[100px] border-slate-100 bg-slate-50 focus-visible:ring-indigo-500 resize-none rounded-xl"
                value={postContent}
                onChange={(e) => setPostContent(e.target.value)}
              />
              <div className="flex justify-between items-center">
                <div className="flex gap-2">
                  <Button variant="ghost" size="sm" className="text-slate-500 hover:text-indigo-600 gap-2 rounded-lg">
          ...
          <Card key={post.id} className="border-none shadow-sm bg-white overflow-hidden rounded-2xl">
            <div className="p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Avatar className="ring-2 ring-indigo-50">
            ...
            <div className="p-4 border-t flex items-center justify-between bg-slate-50/50">
              ...
              <div className="flex items-center gap-1 text-amber-600 bg-amber-50 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider border border-amber-100">
      ...
      <div className="space-y-6">
        <Card className="p-6 border-none shadow-sm bg-indigo-600 text-white rounded-2xl">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={item.name} className="flex items-center justify-between text-sm p-2 rounded-xl hover:bg-white/10 transition-colors">
                <div className="flex items-center gap-3">
                  <span className={`w-6 h-6 flex items-center justify-center rounded-lg text-[10px] font-black ${
                    item.rank === 1 ? 'bg-amber-400 text-indigo-900' : 'bg-white/20 text-white'
                  }`}>
                    {item.rank}
                  </span>
          ...
          <Button variant="secondary" className="w-full mt-6 bg-white text-indigo-600 hover:bg-indigo-50 text-xs font-black rounded-xl h-12">
        ...
        <Card className="p-6 border-none shadow-sm bg-white rounded-2xl">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
              <p className="text-[10px] font-black text-indigo-600 uppercase mb-2 tracking-widest">Dica do Dia</p>
              <p className="text-xs text-slate-600 leading-relaxed">Postar fotos de alta qualidade dos seus shows aumenta em 40% suas chances de contratação.</p>
            </div>
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
              <p className="text-[10px] font-black text-emerald-600 uppercase mb-2 tracking-widest">Gamificação</p>
              <p className="text-xs text-slate-600 leading-relaxed">Responda aos comentários dos seus posts para ganhar pontos em dobro hoje!</p>
            </div>
          </div>
        </Card>
      </div>
